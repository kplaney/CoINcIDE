...
saveRDS(CoINcIDE_results,file=paste0(saveDir,"/CoINcIDE_results_",experimentName,"_",edgeMethod,"edgeMethod_",centroidMethod,"_centroidMethod",Sys.Date(),".rds"),compress=TRUE)
...
saveRDS(CoINcIDE_outputList,file=paste0(saveDir,"/CoINcIDE_Nullresults_",experimentName,"_",edgeMethod,"edgeMethod_",centroidMethod,"_centroidMethod",Sys.Date(),".rds"),compress=TRUE)
...
message(paste0(saveDir,"/CoINcIDE_results_",experimentName,"_",edgeMethod,"edgeMethod_",centroidMethod,"_centroidMethod",Sys.Date(),".RData.gzip"))
message(paste0(saveDir,"/CoINcIDE_Nullresults_",experimentName,"_",edgeMethod,"edgeMethod_",centroidMethod,"_centroidMethod",Sys.Date(),".RData.gzip"))
message(paste0(saveDir,"/CoINcIDE_globalFDRresults_",experimentName,"_",edgeMethod,"edgeMethod_",centroidMethod,"_centroidMethod",Sys.Date(),".RData.gzip"))
