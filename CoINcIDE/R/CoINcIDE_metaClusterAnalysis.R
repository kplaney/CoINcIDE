...
GSEA_DAVID <- function(testGeneVector,geneType="GENE_SYMBOL",yourEmail){
  ...
  connect(david)
  result<-addList(david, testGeneVector,
  ...
  output <- (termCluster=termClust,getClusterReportFile=getClusterReportFile)
