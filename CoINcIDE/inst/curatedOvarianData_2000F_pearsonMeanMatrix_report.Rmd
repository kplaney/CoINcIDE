...
CoINcIDE_rankFeatures <- "/home/kplaney/ovarian_analysis/metaFeatures_2000.RData.gzip"
load(CoINcIDE_rankFeatures)
metaFeatures <- metaFeatures
CoINcIDE_clusterOutput <-  "/home/kplaney/ovarian_analysis/curatedOvarianData_kmeansConsensus_nstart1_2000Features_2015-04-30.RData.gzip"
...
CoINcIDE_computeEdgesObject <- "/home/kplaney/ovarian_analysis/adjMatrices_2000F_pearson_meanMatrix_updated2015-05-01RData.gzip"
load(CoINcIDE_computeEdgesObject)
output <- ov_2000F_pearson_meanMatrix
...
#NOTE: for ovarian, lots of smaller clusters: lower from 10.
clustSizeThresh <- 5
...
sigGenes <- selectMetaclustSigGenes(computeMetaclustEffectSizesOutput=ES_out,qvalueThresh=.5,
                                    ESthresh=1)
...
for(c in 1:length(sigGenes$sigMetaclustGenes_pos)){
  ...
  cat("\n",length(testGeneSet)," genes for community ", c, " with >= ES of .5\n")
...
save(GSEA_out,file="/home/kplaney/ovarian_analysis/DAVID/GSEA_out_2000F_pearson_ESpt5.RData.gzip",compress="gzip")
...
save(GSEA_out_unique,file="/home/kplaney/ovarian_analysis/DAVID/GSEA_out_uniqueSigLists_forEachMetaCluster_2000F_pearson_ESpt5.RData.gzip",compress="gzip")
...
#               names(sigGenes$sigMetaclustGenes_pos)[c],"_pearson500F.txt"),quote=FALSE,
...
#                        pvalueThreshCluster=.2,fileTag=paste0("pearson500F_commmunity_",c),
...
#   cat(as.character(unlist(DAVID_out[[c]]$sigFunctGroups$Term)),"\n\n")
#   
...
save(DAVID_out,file="/home/kplaney/ovarian_analysis/DAVID_500F_pearsonMatrix.RData.gzip",compress="gzip")
