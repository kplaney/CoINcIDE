...
load(paste0("/home/kplaney/breast_analysis_withTop20Genes/","/adjMatrices_200F_pearson_meanMatrix_2015-05-05.RData.gzip"))
 breast200F_pearson_meanMatrix$computeTrueSimilOutput <- breast200F_pearson_meanMatrix$threshStats
breast200F_pearson_meanMatrix$computeTrueSimilOutput$meanMetricMatrix <- breast200F_pearson_meanMatrix$meanMetricMatrix
 breast200F_pearson_meanMatrix$computeTrueSimilOutput$trueFractNNmatrix <- breast200F_pearson_meanMatrix$trueFractNNmatrix
...
breast_200Out <- metaFeaturesAnalysisWrapper(metaFeatures=metaFeatures,esets=esets,CoINcIDE_output=CoINcIDE_output , clusterCoINcIDE_output=clusterCoINcIDE_output,
                                             ...
                                             GSEAanalysis=FALSE,clinVarPlots=FALSE)
