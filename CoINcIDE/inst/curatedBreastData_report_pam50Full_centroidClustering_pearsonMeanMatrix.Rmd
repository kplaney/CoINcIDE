curatedBreastData meta-clustering with 200 (meta-rank) features using kmeans consensus
========================================================
**Data loading**
...
CoINcIDE_clusterOutput <-  "/home/kplaney/breast_analysis//pam50Full_centroidCluster.RData.gzip"
load(CoINcIDE_clusterOutput)
clusterOutput <- pam50Full_centroidCluster
#data matrix list:
...
clustSampleIndexList <-  clusterOutput$clustSampleIndexList
clustFeatureIndexList <- clusterOutput$clustFeatureIndexList


CoINcIDE_computeEdgesObject <- "/home/kplaney/breast_analysis/adjMatrices_pam50Full_centroidCluster_pearson_meanMatrix_2015-05-03.RData.gzip"
load(CoINcIDE_computeEdgesObject)
output <- pam50Full_centroidCluster_pearson_meanMatrix
...
As we can see in these plots, 4 meta-clusters remained after edge filtering. Note how datasets 12 and 13 have been dropped; this didn't happen with the Gap statistic. The GSE25055 dataset still showed up, but the I-SPY dataset did not. It appears that the clusterings this time around were perhaps not granular enough??
...
finalEdgeInfo <- assignFinalEdges(computeTrueSimilOutput=computeTrueSimilOutput,pvalueMatrix=pvalueMatrix,indEdgePvalueThresh=indEdgePvalueThresh,
                              ...
                              clustSizeThresh=clustSizeThresh, clustSizeFractThresh= clustSizeFractThresh,saveDir=saveDir,fileTag="CoINcIDE_edges_",restrictEdges=FALSE,clustIndexMatrix=clustIndexMatrix
)
