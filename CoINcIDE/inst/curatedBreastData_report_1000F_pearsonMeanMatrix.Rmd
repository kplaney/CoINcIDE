...
CoINcIDE_clusterOutput <-  "/home/kplaney/breast_analysis/curatedbreastData_kmeansConsensus_nstart1pItem91000Features_2015-05-05.RData.gzip"
...
CoINcIDE_computeEdgesObject <- "/home/kplaney/breast_analysis/adjMatrices_1000F_pearson_meanMatrix_2015-05-05.RData.gzip"
load(CoINcIDE_computeEdgesObject)
output <- breast1000F_pearson_meanMatrix
...
#edge between gives slightly more interpretable results...but stick with fastgreedy; 
#over multiple runs for different analyses gives slightly more intuitive results.
commInfo <- findCommunities(edgeMatrix=finalEdgeInfo$filterEdgeOutput$edgeMatrix,edgeWeightMatrix=finalEdgeInfo$filterEdgeOutput$edgeWeightMatrix,
                            ...
                            saveDir=saveDir,minNumUniqueStudiesPerCommunity=4,clustMethodName="",
...
commInfo$attrDF$size <- clustSizes[na.omit(match(commInfo$attrDF$clust,names(clustSizes)))]
 advancedNetworkPlots(communityMembership=commInfo,
                                  brewPal = c("Set3"),clustIndexMatrix=clustIndexMatrix,
                                  saveDir=saveDir,experimentName="network",
...
load("/home/kplaney/breast_analysis/")
...
save(GSEA_out_unique,file="/home/kplaney/ovarian_analysis/DAVID/GSEA_out_uniqueSigLists_forEachMetaCluster_200F_pearson_ES1.RData.gzip",compress="gzip")
```
**Survival Analyses**
