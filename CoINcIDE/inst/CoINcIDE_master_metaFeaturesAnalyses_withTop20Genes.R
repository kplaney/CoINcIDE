...
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes/adjMatrices_200F_spearman_meanMatrix_2015-04-29RData.gzip")
CoINcIDE_output = ov_200F_spearman_meanMatrix
experimentName <- "ovarian_200_spearman"
eset_featureDataFieldName="gene"
networkColors = "Set2"
...
source("/home/kplaney/gitRepos/CoINcIDE/coincide/CoINcIDE/inst/CoINcIDE_metaFeatures_analysis_wrapper.R")
#grab data matrix list, clust features list
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/metaFeatures_500.RData.gzip")
metaFeatures =metaFeatures
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/curatedOvarianData_kmeansConsensus_nstart1_500Features_2015-04-29.RData.gzip")
clusterCoINcIDE_output =  kmeansConsensus
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/esets_proc_TCGAcombat.RData.gzip")
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/adjMatrices_500F_pearson_meanMatrix_2015-04-29RData.gzip")
CoINcIDE_output = ov_500F_pearson_meanMatrix
experimentName <- "ovarian_500_pearson"
fisherTestVariables <- c("histological_type","tumorstage","recurrence_status","grade","age_at_initial_pathologic_diagnosis")
fisherTestVariableLegendNames <- c("hist\ntype","tumor\nstage","recurrence","tumor\ngrade","age")
fisherTestVariableTitleNames <- c("histological type","tumor stage", "recurrence status","tumor grade","age at diagnosis")
eset_featureDataFieldName="gene"
...
source("/home/kplaney/gitRepos/CoINcIDE/coincide/CoINcIDE/inst/CoINcIDE_metaFeatures_analysis_wrapper.R")
#grab data matrix list, clust features list
load("/home/kplaney/ovarian_analysis_withTop20Genes/metaFeatures_500.RData.gzip")
metaFeatures =metaFeatures
load("/home/kplaney/ovarian_analysis_withTop20Genes/curatedOvarianData_kmeansConsensus_nstart1_500Features_2015-04-29.RData.gzip")
clusterCoINcIDE_output =  kmeansConsensus
load("/home/kplaney/ovarian_analysis_withTop20Genes/esets_proc_TCGAcombat.RData.gzip")
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes/adjMatrices_500F_spearman_meanMatrix_2015-04-29RData.gzip")
CoINcIDE_output = ov_500F_spearman_meanMatrix
experimentName <- "ovarian_500_spearman"
fisherTestVariables <- c("histological_type","tumorstage","recurrence_status","grade","age_at_initial_pathologic_diagnosis")
fisherTestVariableLegendNames <- c("hist\ntype","tumor\nstage","recurrence","tumor\ngrade","age")
fisherTestVariableTitleNames <- c("histological type","tumor stage", "recurrence status","tumor grade","age at diagnosis")
eset_featureDataFieldName="gene"
...
source("/home/kplaney/gitRepos/CoINcIDE/coincide/CoINcIDE/inst/CoINcIDE_metaFeatures_analysis_wrapper.R")
#grab data matrix list, clust features list
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/metaFeatures_1000.RData.gzip")
metaFeatures =metaFeatures
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/curatedOvarianData_kmeansConsensus_nstart1_1000Features_2015-04-29.RData.gzip")
clusterCoINcIDE_output =  kmeansConsensus
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/esets_proc_TCGAcombat.RData.gzip")
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes_withTop20Genes/adjMatrices_1000F_pearson_meanMatrix_2015-04-29RData.gzip")
...
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes/adjMatrices_1000F_pearson_meanMatrix_updated2015-05-21.RData.gzip")
CoINcIDE_output = ov_1000F_spearman_meanMatrix
experimentName <- "ovarian_1000_spearman"
fisherTestVariables <- c("histological_type","tumorstage","recurrence_status","grade","age_at_initial_pathologic_diagnosis")
fisherTestVariableLegendNames <- c("hist\ntype","tumor\nstage","recurrence","tumor\ngrade","age")
fisherTestVariableTitleNames <- c("histological type","tumor stage", "recurrence status","tumor grade","age at diagnosis")
eset_featureDataFieldName="gene"
...
esets = esets
#dataMatrixList
load("/home/kplaney/ovarian_analysis_withTop20Genes/adjMatrices_2000F_spearman_meanMatrix2015-05-21.RData.gzip")
CoINcIDE_output = ov_2000F_spearman_meanMatrix
experimentName <- "ovarian_2000_spearman"
fisherTestVariables <- c("histological_type","tumorstage","recurrence_status","grade","age_at_initial_pathologic_diagnosis")
fisherTestVariableLegendNames <- c("hist\ntype","tumor\nstage","recurrence","tumor\ngrade","age")
fisherTestVariableTitleNames <- c("histological type","tumor stage", "recurrence status","tumor grade","age at diagnosis")
...
source("/home/kplaney/gitRepos/CoINcIDE/coincide/CoINcIDE/inst/CoINcIDE_metaFeatures_analysis_wrapper.R")
#grab data matrix list, clust features list
saveDir <- "/home/kplaney/breast_analysis_withTop20Genes/"
...
#####pam50 full kmeans
source("/home/kplaney/gitRepos/CoINcIDE/coincide/CoINcIDE/inst/CoINcIDE_metaFeatures_analysis_withTop20Genes_wrapper.R")
#grab data matrix list, clust features list
saveDir <- "/home/kplaney/breast_analysis_withTop20Genes/"
load("/home/data/breast_microarrayDB/pam50_centroids_updatedSymbols.RData")
pam50Genes <- centroidMatrix[,1]
...
save(breast_hclustGap_pam50FullOut,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_pam50FullOut.RData.gzip"),compress="gzip")
...
save(breast_hclustGap_pam50ShortOut,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_pam50FullOut.RData.gzip"),compress="gzip")

####200 features
"/home/kplaney/breast_analysis_withTop20Genes//curatedbreastData_kmeansGap_nstart25_200_features_2015-05-18.RData.gzip"
"/home/kplaney/breast_analysis_withTop20Genes/adjMatrices_breast200F_kmeansGap_pearson_meanMatrix_2015-05-18.RData.gzip"
#500 features
"/home/kplaney/breast_analysis_withTop20Genes//curatedbreastData_kmeansGap_nstart25_500_features_2015-05-18.RData.gzip"
"/home/kplaney/breast_analysis_withTop20Genes/adjMatrices_breast500F_kmeansGap_pearson_meanMatrix_2015-05-18.RData.gzip"
#1000 features
"/home/kplaney/breast_analysis_withTop20Genes//curatedbreastData_kmeansGap_nstart25_1000_features_2015-05-18.RData.gzip"
...
save(breast_hclustGap_200Out,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_200Out.RData.gzip"),compress="gzip")
...
save(breast_hclustGap_500Out,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_500Out.RData.gzip"),compress="gzip")
...
save(breast_hclustGap_1000Out,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_1000Out.RData.gzip"),compress="gzip")
...
save(breast_hclustGap_2000Out,file=paste0("/home/kplaney/breast_analysis_withTop20Genes/",experimentName,"_",Sys.Date(),"/breast_hclustGap_2000Out.RData.gzip"),compress="gzip")
...
load(paste0(saveDir,"/curatedBreastData_esets_proc_minVar001_min10kGenes_min40Samples.RData.gzip"))
esets=esets_minVar001_17_studies
load(paste0(saveDir,"/adjMatrices_200F_pearson_centroid_2015-05-18.RData.gzip"))
