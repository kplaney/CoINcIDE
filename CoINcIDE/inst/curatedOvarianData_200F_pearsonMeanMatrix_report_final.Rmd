...
CoINcIDE_clusterOutput <-  "/home/kplaney/ovarian_analysis/curatedOvarianData_kmeansConsensus_nstart1_200Features_2015-04-28.RData.gzip"
...
CoINcIDE_computeEdgesObject <- "/home/kplaney/ovarian_analysis/adjMatrices_200F_pearson_meanMatrix_2015-04-29RData.gzip"
load(CoINcIDE_computeEdgesObject)
output <- ov_200F_pearson_meanMatrix
...
for(c in 1:length(sigGenes$sigMetaclustGenes_pos)){
  ...
  DAVID_out[[c]] <- GSEA_DAVID(testGeneVector=testGeneSet,idType="GENE_SYMBOL",yourEmail="katie.planey@stanford.edu",
                       ...
                       pvalueThreshCluster=.2,fileTag=paste0("pearson200F_commmunity_",c),
...
save(DAVID_out,file="/home/kplaney/ovarian_analysis/DAVID_200F_pearsonMatrix.RData.gzip",compress="gzip")
